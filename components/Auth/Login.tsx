...
const Login: React.FC<LoginProps> = ({ onGuestEntry }) => {
      ...
      <div className="z-10 w-full max-w-md p-8 flex flex-col items-center text-center space-y-8">
        ...
        <div className="space-y-2">
          ...
          <p className="text-slate-400 font-medium leading-relaxed">
            Your cinematic focus sanctuary. Cloud-sync your sessions or keep them private on this device.
          </p>
        </div>
        ...
        <div className="w-full space-y-3">
          ...
          <button
            ...
            className="w-full bg-slate-900 text-slate-300 py-4 px-6 rounded-2xl font-bold border border-slate-800 hover:bg-slate-800 hover:text-white transition-all active:scale-95"
          >
            Continue as Guest
          </button>
        </div>
        ...
        <p className="text-xs text-slate-500 font-bold uppercase tracking-widest">
          Guest mode saves data locally to your browser
        </p>
      </div>
    </div>
  );
